...
public class CreateUsersWriter implements IWriter<UserToCreateDTO> {
    ...
    @Override
    public ItemWriter<UserToCreateDTO> writer() {
        return new CreateUsersWriterImpl();
    }

    private class CreateUsersWriterImpl implements ItemWriter<UserToCreateDTO> {
        @Override
        public void write(Chunk<? extends UserToCreateDTO> chunk) {
            ...
            users.forEach(user -> {
                ...
                UsersToCreateEntity updatedUserToCreate = usersToCreateService.updateUserToCreate(
                        user.getUsersToCreateId());
